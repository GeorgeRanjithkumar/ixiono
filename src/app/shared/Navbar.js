...
//             <li className="nav-item font-weight-semibold d-none  d-md-flex">Help : +050 2992 709 <div class="input-box">
...
//             <li className="nav-item  nav-profile border-2">
//               <Dropdown>
//                 <Dropdown.Toggle className="nav-link count-indicator bg-transparent">
//                   {/* <img className="img-xs rounded-square" src={require("../../assets/images/faces/face8.jpg")} alt="Profile" /> */}
...
// 											<p className="designation">id:3848</p>
// 										</div>
// 									</div>
//                 </Dropdown.Toggle>
        ...
        <a className="navbar-brand brand-logo-mini align-self-center d-lg-none" href="!#" onClick={evt =>evt.preventDefault()}><img src={require("../../assets/images/logo-mini.svg")} alt="logo" /></a>
          ...
          <ul className="navbar-nav navbar-nav-left header-links align-self-center">
			...
			<div style={{position:"relative"}}>
					<input type="text" className={`form-control ${styles.navInput}`} placeholder="search"/>
          ...
          <ul className="navbar-nav navbar-nav-right">
			...
			<li className="nav-item  nav-profile border-0 pl-4">
              <Dropdown>
                <Dropdown.Toggle className="nav-link count-indicator p-0 toggle-arrow-hide bg-transparent">
				     ...
				     <i className={`mdi mdi-account-plus ${styles.mdi}`}></i>
            ...
            <li className="nav-item  nav-profile border-0">
              <Dropdown>
                <Dropdown.Toggle className="nav-link count-indicator p-0 toggle-arrow-hide bg-transparent">
					...
					<i className={`mdi mdi-email ${styles.mdi}`}></i>
			...
			<li className="nav-item  nav-profile border-0">
              <Dropdown>
                <Dropdown.Toggle className="nav-link count-indicator p-0 toggle-arrow-hide bg-transparent">
					...
					<i className={`mdi mdi-bell ${styles.mdi}`}></i>
                </Dropdown.Toggle>
                <Dropdown.Menu className="navbar-dropdown preview-list">
                  <Dropdown.Item className="dropdown-item  d-flex align-items-center" href="!#" onClick={evt =>evt.preventDefault()}>
                    <p className="mb-0 font-weight-medium float-left"><Trans>You have</Trans> 7 <Trans>unread mails</Trans> </p>
            ...
            <li className="nav-item  nav-profile border-0" style={{marginTop:"1rem"}}>
              <Dropdown>
                <Dropdown.Toggle className="nav-link count-indicator bg-transparent" style={{display:"flex"}}>
                  <img width="40rem" src={require("../../assets/images/faces/face29.png")} alt="Profile" />
					<div style={{marginLeft:"1rem"}}>
						<h6 style={{textTransform:"capitalize"}}>anddy's makeover</h6>
						<p className={`${styles.profileId}`} style={{textTransform:"uppercase",color:"#DEDEDE"
