        ...
        <>
            ...
            <div className='card-body'>
                ...
                <div class="mb-3">
                    ...
                    <textarea className={`form-control ${styles.textarea}`} placeholder="Start A Discussion"></textarea>
                </div>
                        ...
                        <div className='card' style={{backgroundColor:"#F9FAFF",boxShadow:"none"}}>
                            <div className={`card-body  ${styles.cardBody}`}>
                                ...
                                <div>
                                    ...
                                    <p style={{color:"#C5C6C9"}}>simply decide on a subject and choose <br></br>who to invite</p>
                                    <div>
