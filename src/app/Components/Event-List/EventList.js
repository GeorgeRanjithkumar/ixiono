                        ...
                        <div className='card-body'>
                            ...
                            <div className='row'>
                                ...
                                <div className={`${styles.cardHead}`}>
                                    ...
                                    <p style={{textTransform: "capitalize",fontWeight:"normal"}}>1 going - 0 intersted</p>
                                </div>
                                ...
                                <div className='text-right'>
                                <Link className={`btn ${styles.btn}`} style={{width:"9.8rem"}} to="/Event-Details/EventDetails">
