        ...
        <div className="row">
          <div className="col-md-3">
            <div className="card text-center">
              <div className="card-header text-white" style={{backgroundColor:"#401AAB"}}>
                <h5>
                  $259.08
                  <br />
                  Trans Total
          ...
          <div className="col-md-3">
            <div className="card text-center">
              <div className="card-header text-white" style={{backgroundColor:"#65AC23"}}>
                <h5>
                  $259.08
                  <br />
                  Trans Amount
          ...
          <div className="col-md-3">
            <div className="card text-center">
			<div className="card-header text-white" style={{backgroundColor:"#AB4627"}}>
                <h5>
                  $259.08
                  <br />
                  Customer Total
          ...
          <div className="col-md-3">
            <div className="card text-center">
			<div className="card-header text-white" style={{backgroundColor:"#AB1A8B"}}>
                <h5>
                  $259.08
                  <br />
                  Transaction
